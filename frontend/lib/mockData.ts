...
export const mockSuggestions: Suggestion[] = [
  ...
  // ═══ Demo Plant (PLT-03) suggestions ═══
  {
    id: "demo-01",
    suggestionNo: "DEMO-2026-001",
    ...
    presentMethod: "Conveyor belt is manually monitored and stopped by foot pedal when parts accumulate.",
    proposedMethod: "Install automated optical sensor at discharge chute that halts the motor automatically.",
  ...
  },
  {
    ...
    date: "2026-09-12",
    daysPending: 10,
    pendingWith: "Planning Engineer",
    employeeNo: "DEMO-1001",
    employeeName: "Alex Morgan",
    department: "Innovation & Ops",
    presentMethod: "Cabin lighting remains at 100% luminance 24 hours regardless of occupancy.",
    proposedMethod: "Motion PIR sensor connected to dimming controller drops lighting to 15% after 2 mins of inactivity.",
  ...
  },
  {
    ...
    employeeName: "Alex Morgan",
    department: "Innovation & Ops",
    presentMethod: "Manual caliper measurement took 22 minutes per fixture during production changeovers.",
    proposedMethod: "Fabricated quick-clamp locator with preset dowel pins.",
    benefits: "Reduced changeover time from 22 mins to 4 mins, saving 14 production hours monthly.",
    awardAmount: 1500,
    awardCategory: "Certificate + Cash",
  ...
  },
  {
    ...
    employeeName: "Alex Morgan",
    department: "Innovation & Ops",
    presentMethod: "Hoses hang across workstation walkways creating tripping hazard and wrist strain.",
    proposedMethod: "Overhead spring balancers to suspend pneumatic tools at eye level.",
  ...
  },
  {
    ...
    date: "2026-09-10",
    daysPending: 6,
    pendingWith: "Execution Team",
    employeeNo: "DEMO-1001",
    employeeName: "Alex Morgan",
    department: "Innovation & Ops",
    presentMethod: "Drip trays collect hydraulic seepage that is wiped and discarded in hazardous waste bins weekly.",
    proposedMethod: "Install self-priming sump pump connected to a portable 5-micron centrifugal filtering unit for reclaiming clean hydraulic fluid.",
  ...
  },
  {
    ...
    employeeName: "Alex Morgan",
    department: "Innovation & Ops",
    presentMethod: "Single magnetic switch had occasional contact bounce during high vibration.",
    proposedMethod: "Replaced with dual-channel RFID keyed safety interlock with emergency stop relay integration.",
    benefits: "Zero safety breaches, Category 4 safety compliance achieved, certified by plant EHS team.",
    awardAmount: 5000,
    awardCategory: "Director Safety Award",
    awardDate: "2026-08-25",
    formData: {
  ...
  },
  {
    ...
    date: "2026-09-04",
    daysPending: 8,
    pendingWith: "Evaluation Committee",
    employeeNo: "DEMO-1001",
    employeeName: "Alex Morgan",
    department: "Innovation & Ops",
    presentMethod: "Operators hand-wrote serialized dispatch carton numbers on clipboards.",
    proposedMethod: "Handheld Bluetooth 2D barcode scanner pairing directly with ERP batch queue.",
  ...
  },
  {
    ...
    employeeName: "Alex Morgan",
    department: "Innovation & Ops",
    presentMethod: "Machinists manually mixed oil-water emulsion with dipsticks twice every shift.",
    proposedMethod: "Installed proportional venturi mixer with ultrasonic level float valve.",
    benefits: "Stable 7.5% emulsion concentration maintained, cutting coolant consumption by 22% and tool wear by 15%.",
    awardAmount: 2000,
    awardCategory: "Cost Optimization Award",
  ...
  },
  {
    ...
    date: "2026-09-01",
    daysPending: 3,
    pendingWith: "Award Committee",
    employeeNo: "DEMO-1001",
    employeeName: "Alex Morgan",
    department: "Innovation & Ops",
    presentMethod: "Open-ended 6mm copper pipes blew off machining debris at 6 bar continuously.",
    proposedMethod: "Swapped to aerodynamic Coanda-effect air amplifiers delivering high thrust with 65% less air.",
  ...
  },
  {
    ...
    employeeName: "Alex Morgan",
    department: "Innovation & Ops",
    presentMethod: "Paper logbook records torque calibration check twice daily.",
    proposedMethod: "Dedicated tablet connected over BLE to digital torque wrenches.",
    benefits: "Instant audit traceability for critical fastener torques.",
    rejectionReason: "Similar torque telemetry pilot already underway with Global IT vendor.",
    rejectedByName: "David Chen",
    rejectedOn: "2026-09-05",
    formData: {
      machineRefType: "name",
  ...
  },
  {
    ...
    employeeName: "Alex Morgan",
    department: "Innovation & Ops",
    presentMethod: "Wrenches and allen keys stored in shared toolbox requiring walking back and forth.",
    proposedMethod: "Mobile magnetic shadow board cart with dedicated foam cutouts for each hex tool.",
  ...
  },
  {
    ...
    employeeName: "Alex Morgan",
    department: "Innovation & Ops",
    presentMethod: "Ceiling tube light reflection caused operator eye fatigue and missed micro-cracks.",
    proposedMethod: "3D-printed matte black shroud and ring light diffuser fitted over the stereomicroscope.",
    benefits: "Eliminated glare reflection; defect detection rate improved from 92% to 99.4%.",
    awardAmount: 1500,
    awardCategory: "Quality Kaizen Award",
