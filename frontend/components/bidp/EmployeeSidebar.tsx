// BidP — Employee Sidebar
// This file owns all BidP employee menu items. Never import JaP items here.
import { Home, FilePlus, Copy, FolderOpen, Trophy, BookOpen, ArrowLeft } from "lucide-react";
...
const BidPEmployeeSidebarContent = ({ onClose }: Props) => {
...
export default BidPEmployeeSidebarContent;
