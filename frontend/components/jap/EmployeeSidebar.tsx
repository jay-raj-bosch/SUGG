// JaP — Employee Sidebar
// This file owns all JaP employee menu items. Never import BidP items here.
...
const JaPEmployeeSidebarContent = ({ onClose }: Props) => {
  ...
  const menuItems = [
    ...
    { title: "My Suggestions", translationKey: "\u092e\u0947\u0930\u0947 \u0938\u0941\u091d\u093e\u0935",  url: `${plantPrefix}/employee/my-suggestions`,   icon: ListChecks, end: false },
    { title: "My Rewards",      translationKey: "My Rewards",                                                  url: `${plantPrefix}/employee/my-rewards`,        icon: Trophy,     end: false },
  ];
    ...
    <>
      <div className="px-3 py-3 border-b border-sidebar-border">
        <p className="text-[10px] font-semibold uppercase tracking-wider text-sidebar-primary">
          Employee Menu / <span>{t("Employee Menu")}</span>
        </p>
      </div>
...
export default JaPEmployeeSidebarContent;
