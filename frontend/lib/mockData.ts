...
export const mockSuggestions: Suggestion[] = [
  ...
  },
  {
    ...
    employeeName: "Alex Morgan",
    department: "Innovation & Ops",
    presentMethod: "Assembly kits picked manually using paper bill of materials, causing 8-12 min operator picking delay.",
    proposedMethod: "Installed Arduino-driven LED addressable strips on kit bins synced to barcode scanner.",
  ...
  },
  {
    ...
    employeeName: "Alex Morgan",
    department: "Innovation & Ops",
    presentMethod: "Pressure dial read manually with no clear indicator of operating range tolerances.",
    proposedMethod: "Adhesive high-visibility color sector overlays indicating nominal (5.5-6.5 bar), caution, and alarm zones.",
  ...
  },
  {
    ...
    employeeName: "Alex Morgan",
    department: "Innovation & Ops",
    presentMethod: "Manual scraping with ceramic deburring knives leaving micro-burrs and inconsistent finish.",
    proposedMethod: "Dry-ice cryogenic pellet blasting cabinet with rotary indexing table.",
    benefits: "100% burr-free edges, zero chemical residues, cycle time reduced by 68%.",
    awardAmount: 4500,
    awardCategory: "Innovation Excellence Award",
    awardDate: "2026-08-15",
    implementedOn: "2026-08-10",
    formData: {
  ...
  },
  {
    ...
    employeeName: "Alex Morgan",
    department: "Innovation & Ops",
    presentMethod: "Small desk fan dissipating fumes into open room atmosphere.",
    proposedMethod: "Articulated arm fume extractor ducted to HEPA/Carbon active filtration exhaust unit.",
  ...
  },
  {
    ...
    employeeName: "Alex Morgan",
    department: "Innovation & Ops",
    presentMethod: "11 different non-standard box sizes ordered in small batches with low bulk discounts.",
    proposedMethod: "Consolidate into 3 ISO-pallet modular carton dimensions (Small, Medium, Master).",
  ...
  },
  {
    ...
    employeeName: "Alex Morgan",
    department: "Innovation & Ops",
    presentMethod: "Access hatch had mechanical lock requiring operator key, but rotor spun for 90s after power cut.",
    proposedMethod: "Zero-speed magnetic safety switch prevents hatch release solenoid until shaft RPM reaches 0.",
    benefits: "Completely eliminates rotating machinery entrapment hazard for maintenance personnel.",
    awardAmount: 7500,
    awardCategory: "Plant Safety Champion Award",
    awardDate: "2026-09-10",
    implementedOn: "2026-08-30",
    formData: {
      scheme: "suggestion",
      plant: "JaP",
      machineRefType: "name",
